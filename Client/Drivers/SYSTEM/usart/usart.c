...
static UART_HandleTypeDef g_uart_dbg_handle = {0};  /* debug log UART: USART1 */
...
static void usart_debug_init(uint32_t baudrate)
{
    ...
    /* USART1 TX: PA9, RX: PA10 (debug terminal) */
...
{
    /* Init dedicated debug UART first (USART1: PA9/PA10) */
    usart_debug_init(baudrate);
...
void HAL_UART_MspInit(UART_HandleTypeDef *huart)
{
    ...
    {
        /* USART6: PC6 TX / PC7 RX (AF8), RS485 与 app_rs485_link 一致 */
