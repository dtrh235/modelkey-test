...
int screen_digital_clock_1_min_value = 42;
int screen_digital_clock_1_hour_value = 19;
int screen_digital_clock_1_sec_value = 34;
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_img_set_src(ui->screen_img_3, &_3_alpha_240x320);
    lv_img_set_pivot(ui->screen_img_3, 50,50);
    lv_img_set_angle(ui->screen_img_3, 0);
    lv_obj_set_pos(ui->screen_img_3, 0, 0);
    lv_obj_set_size(ui->screen_img_3, 240, 320);
    ...
    lv_img_set_src(ui->screen_img_2, &_2_alpha_82x77);
    lv_img_set_pivot(ui->screen_img_2, 50,50);
    lv_img_set_angle(ui->screen_img_2, 0);
    lv_obj_set_pos(ui->screen_img_2, 83, 14);
    lv_obj_set_size(ui->screen_img_2, 82, 77);
    ...
    lv_label_set_text(ui->screen_btn_2_label, "开锁");
    ...
    lv_obj_set_pos(ui->screen_btn_2, 176, 288);
    lv_obj_set_size(ui->screen_btn_2, 62, 30);

    //Write style for screen_btn_2, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_btn_2, 165, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_btn_2, lv_color_hex(0x009bff), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_digital_clock_1 = lv_dclock_create(ui->screen, "19:42");
    ...
    lv_obj_set_pos(ui->screen_digital_clock_1, 18, 103);
    lv_obj_set_size(ui->screen_digital_clock_1, 214, 66);
    ...
    lv_obj_set_style_text_font(ui->screen_digital_clock_1, &lv_font_montserratMedium_51, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_datetext_1, "2026/04/13");
    ...
    lv_obj_set_pos(ui->screen_datetext_1, 62, 171);
    lv_obj_set_size(ui->screen_datetext_1, 131, 35);
    ...
    lv_obj_set_style_text_font(ui->screen_datetext_1, &lv_font_montserratMedium_19, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_btn_3_label, "菜单");
    ...
    lv_obj_set_pos(ui->screen_btn_3, 3, 288);
    lv_obj_set_size(ui->screen_btn_3, 62, 30);

    //Write style for screen_btn_3, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_btn_3, 165, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_btn_3, lv_color_hex(0x009bff), LV_PART_MAIN|LV_STATE_DEFAULT);
