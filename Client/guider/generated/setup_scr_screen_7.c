...
void setup_scr_screen_7(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen_7, 240, 320);
    ...
    lv_obj_set_size(ui->screen_7_cont_1, 240, 320);
    ...
    lv_obj_set_style_border_opa(ui->screen_7_cont_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_7_cont_1, lv_color_hex(0xfbb1bd), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->screen_7_cont_1, lv_color_hex(0xb1e8fb), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_7_btn_2 = lv_btn_create(ui->screen_7_cont_1);
    ui->screen_7_btn_2_label = lv_label_create(ui->screen_7_btn_2);
    lv_label_set_text(ui->screen_7_btn_2_label, "ESC");
    ...
    lv_obj_set_pos(ui->screen_7_btn_2, 174, 285);
    lv_obj_set_size(ui->screen_7_btn_2, 62, 30);

    //Write style for screen_7_btn_2, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_7_btn_2, 165, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_7_btn_2, lv_color_hex(0x009bff), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_7_btn_2, &lv_font_SourceHanSerifSC_Regular_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_7_label_1, "删除用户");
    lv_label_set_long_mode(ui->screen_7_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_7_label_1, 5, 12);
    lv_obj_set_size(ui->screen_7_label_1, 219, 30);
    ...
    lv_obj_set_style_text_font(ui->screen_7_label_1, &lv_font_SourceHanSerifSC_Regular_25, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_7_btn_1 = lv_btn_create(ui->screen_7_cont_1);
    ui->screen_7_btn_1_label = lv_label_create(ui->screen_7_btn_1);
    lv_label_set_text(ui->screen_7_btn_1_label, "OK");
    ...
    lv_obj_set_pos(ui->screen_7_btn_1, 1, 286);
    lv_obj_set_size(ui->screen_7_btn_1, 62, 30);

    //Write style for screen_7_btn_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_7_btn_1, 165, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_7_btn_1, lv_color_hex(0x009bff), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_7_btn_1, &lv_font_SourceHanSerifSC_Regular_19, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    //Write codes screen_7_ta_1
    ui->screen_7_ta_1 = lv_textarea_create(ui->screen_7_cont_1);
    lv_textarea_set_text(ui->screen_7_ta_1, "");
    lv_textarea_set_placeholder_text(ui->screen_7_ta_1, "");
    lv_textarea_set_password_bullet(ui->screen_7_ta_1, "*");
    lv_textarea_set_password_mode(ui->screen_7_ta_1, false);
    lv_textarea_set_one_line(ui->screen_7_ta_1, true);
    lv_textarea_set_accepted_chars(ui->screen_7_ta_1, "");
    lv_textarea_set_max_length(ui->screen_7_ta_1, 12);
#if LV_USE_KEYBOARD != 0 || LV_USE_ZH_KEYBOARD != 0
    lv_obj_add_event_cb(ui->screen_7_ta_1, ta_event_cb, LV_EVENT_ALL, ui->g_kb_top_layer);
#endif
    lv_obj_set_pos(ui->screen_7_ta_1, 9, 113);
    lv_obj_set_size(ui->screen_7_ta_1, 199, 35);

    //Write style for screen_7_ta_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_text_color(ui->screen_7_ta_1, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_7_ta_1, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_7_ta_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->screen_7_ta_1, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_7_ta_1, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_7_ta_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_7_ta_1, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_7_ta_1, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_7_ta_1, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->screen_7_ta_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_7_ta_1, lv_color_hex(0xe6e6e6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->screen_7_ta_1, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_7_ta_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_7_ta_1, 4, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_7_ta_1, 4, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_7_ta_1, 4, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_7_ta_1, 4, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write style for screen_7_ta_1, Part: LV_PART_SCROLLBAR, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_7_ta_1, 255, LV_PART_SCROLLBAR|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_7_ta_1, lv_color_hex(0x2195f6), LV_PART_SCROLLBAR|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_7_ta_1, LV_GRAD_DIR_NONE, LV_PART_SCROLLBAR|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_7_ta_1, 0, LV_PART_SCROLLBAR|LV_STATE_DEFAULT);

    //Write codes screen_7_label_3
    ui->screen_7_label_3 = lv_label_create(ui->screen_7);
    lv_label_set_text(ui->screen_7_label_3, "学号/工号（1-12位）");
    lv_label_set_long_mode(ui->screen_7_label_3, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_7_label_3, 13, 80);
    lv_obj_set_size(ui->screen_7_label_3, 179, 22);
    ...
    lv_obj_set_style_text_font(ui->screen_7_label_3, &lv_font_SourceHanSerifSC_Regular_19, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_align(ui->screen_7_label_3, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    /* msgbox 改为运行时轻量弹窗，避免页面初始化阶段卡死 */
    ui->screen_7_msgbox_3 = NULL;
    ui->screen_7_msgbox_2 = NULL;
    ui->screen_7_msgbox_1 = NULL;
