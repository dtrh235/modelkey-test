...
void setup_scr_screen_3(lv_ui *ui)
{
    ...
    //Write codes screen_3_btn_3 (item 1: y=60, same row height as 2-5)
    ...
    lv_obj_set_size(ui->screen_3_btn_3, 220, 30);
    ...
    lv_obj_set_style_text_font(ui->screen_3_btn_3_label, &lv_font_SourceHanSerifSC_Regular_21, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_3_btn_4, 8, 103);
    lv_obj_set_size(ui->screen_3_btn_4, 220, 30);
    ...
    lv_obj_set_style_text_font(ui->screen_3_btn_4_label, &lv_font_SourceHanSerifSC_Regular_21, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_3_btn_5, 8, 146);
    lv_obj_set_size(ui->screen_3_btn_5, 220, 30);
    ...
    lv_obj_set_style_text_font(ui->screen_3_btn_5_label, &lv_font_SourceHanSerifSC_Regular_21, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_3_btn_6, 8, 189);
    lv_obj_set_size(ui->screen_3_btn_6, 220, 30);
    ...
    lv_obj_set_style_text_font(ui->screen_3_btn_6_label, &lv_font_SourceHanSerifSC_Regular_21, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_3_btn_7 = lv_btn_create(ui->screen_3_cont_1);
    ui->screen_3_btn_7_label = lv_label_create(ui->screen_3_btn_7);
    lv_label_set_text(ui->screen_3_btn_7_label, "5.设置WiFi");
    lv_label_set_long_mode(ui->screen_3_btn_7_label, LV_LABEL_LONG_WRAP);
    lv_obj_align(ui->screen_3_btn_7_label, LV_ALIGN_LEFT_MID, 0, 0);
    lv_obj_set_style_pad_all(ui->screen_3_btn_7, 0, LV_STATE_DEFAULT);
    lv_obj_set_width(ui->screen_3_btn_7_label, LV_PCT(100));
    lv_obj_set_pos(ui->screen_3_btn_7, 8, 232);
    lv_obj_set_size(ui->screen_3_btn_7, 220, 30);

    lv_obj_set_style_bg_opa(ui->screen_3_btn_7, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_3_btn_7, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_3_btn_7, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_3_btn_7, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_3_btn_7, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_3_btn_7, &lv_font_SourceHanSerifSC_Regular_21, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_3_btn_7_label, &lv_font_SourceHanSerifSC_Regular_21, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_3_btn_7, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_3_btn_7, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);
