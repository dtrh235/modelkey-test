...
/*
 * Keil project currently doesn't compile setup_scr_screen_10.c as a standalone unit.
 * Include it here to provide setup_scr_screen_10 symbol without touching project file.
 */
#include "setup_scr_screen_10.c"
#include "setup_scr_screen_11.c"
