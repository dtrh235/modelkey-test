...
void setup_scr_screen_2(lv_ui *ui)
{
    ...
    lv_obj_set_style_border_color(ui->screen_2_cont_1, lv_color_hex(0xfbb1bd), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->screen_2_cont_1, lv_color_hex(0xb1e8fb), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_2_label_1, "密码（4-10位）");
    lv_label_set_long_mode(ui->screen_2_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_2_label_1, 36, 134);
    lv_obj_set_size(ui->screen_2_label_1, 160, 30);
    ...
    lv_obj_set_style_text_font(ui->screen_2_label_1, &lv_font_SourceHanSerifSC_Regular_21, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_2_ta_1 = lv_textarea_create(ui->screen_2_cont_1);
    lv_textarea_set_text(ui->screen_2_ta_1, "");
    ...
    lv_textarea_set_one_line(ui->screen_2_ta_1, true);
    lv_textarea_set_accepted_chars(ui->screen_2_ta_1, "");
    lv_textarea_set_max_length(ui->screen_2_ta_1, 12);
#if LV_USE_KEYBOARD != 0 || LV_USE_ZH_KEYBOARD != 0
    lv_obj_add_event_cb(ui->screen_2_ta_1, ta_event_cb, LV_EVENT_ALL, ui->g_kb_top_layer);
#endif
    lv_obj_set_pos(ui->screen_2_ta_1, 36, 171);
    lv_obj_set_size(ui->screen_2_ta_1, 160, 35);
    ...
    lv_obj_set_style_text_font(ui->screen_2_ta_1, &lv_font_montserratMedium_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_2_btn_2_label, "OK");
    ...
    lv_obj_set_pos(ui->screen_2_btn_2, 0, 285);
    lv_obj_set_size(ui->screen_2_btn_2, 62, 30);

    //Write style for screen_2_btn_2, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_2_btn_2, 165, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_2_btn_2, lv_color_hex(0x009bff), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_2_btn_2, &lv_font_SourceHanSerifSC_Regular_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_2_btn_1_label, "ESC");
    ...
    lv_obj_set_pos(ui->screen_2_btn_1, 171, 284);
    lv_obj_set_size(ui->screen_2_btn_1, 62, 30);

    //Write style for screen_2_btn_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_2_btn_1, 165, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_2_btn_1, lv_color_hex(0x009bff), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_2_btn_1, &lv_font_SourceHanSerifSC_Regular_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_2_label_2, "管理员账号（1-12位）");
    lv_label_set_long_mode(ui->screen_2_label_2, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_2_label_2, 18, 42);
    lv_obj_set_size(ui->screen_2_label_2, 219, 30);
    ...
    lv_obj_set_style_text_font(ui->screen_2_label_2, &lv_font_SourceHanSerifSC_Regular_21, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_2_ta_2 = lv_textarea_create(ui->screen_2_cont_1);
    lv_textarea_set_text(ui->screen_2_ta_2, "");
    ...
    lv_textarea_set_one_line(ui->screen_2_ta_2, true);
    lv_textarea_set_accepted_chars(ui->screen_2_ta_2, "");
    lv_textarea_set_max_length(ui->screen_2_ta_2, 12);
#if LV_USE_KEYBOARD != 0 || LV_USE_ZH_KEYBOARD != 0
    lv_obj_add_event_cb(ui->screen_2_ta_2, ta_event_cb, LV_EVENT_ALL, ui->g_kb_top_layer);
#endif
    lv_obj_set_pos(ui->screen_2_ta_2, 35, 74);
    lv_obj_set_size(ui->screen_2_ta_2, 160, 35);
    ...
    lv_obj_set_style_text_font(ui->screen_2_ta_2, &lv_font_montserratMedium_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_2_label_3, "输入错误");
    lv_label_set_long_mode(ui->screen_2_label_3, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_2_label_3, 62, 225);
    lv_obj_set_size(ui->screen_2_label_3, 104, 22);
    lv_obj_add_flag(ui->screen_2_label_3, LV_OBJ_FLAG_HIDDEN);
    ...
    lv_obj_set_style_text_color(ui->screen_2_label_3, lv_color_hex(0xff0027), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_2_label_3, &lv_font_SourceHanSerifSC_Regular_16, LV_PART_MAIN|LV_STATE_DEFAULT);
